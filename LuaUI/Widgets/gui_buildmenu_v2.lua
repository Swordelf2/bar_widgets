...
local function drawCell(cellRectID, usedZoom, cellColor, disabled)
	...
	if showPrice then
		...
		local text
		if disabled then
			text = "\255\125\125\125" .. AddSpaces(units.unitMetalCost[uDefID], "") .. "\n\255\135\135\135"
		else
			text = "\255\245\245\245" .. AddSpaces(units.unitMetalCost[uDefID], "") .. "\n\255\255\255\000"
		end
		font2:Print(
			text .. units.unitEnergyCost[uDefID],
			cellRects[cellRectID][1] + cellPadding + (cellInnerSize * 0.048),
