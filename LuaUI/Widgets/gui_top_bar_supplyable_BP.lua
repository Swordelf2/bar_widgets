...
local ui_scale = 1.0 tonumber(Spring.GetConfigFloat("ui_scale", 1) or 1) -- xxx 
...
function init()
	...
	local width = math_floor(totalWidth / 4.6)
	if drawBPBar == true then 
		width = math_floor(totalWidth / barWidthDivisor) --xxx  5.5
	end
